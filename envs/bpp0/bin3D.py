...
from .binCreator import RandomBoxCreator, LoadBoxCreator, BoxCreator, RealBoxCreator
...
class PackingGame(gym.Env):
    def __init__(self, box_creator=None, container_size = (20, 20, 20),
        ...
        if test and not kwargs['real']:
            self.box_creator = LoadBoxCreator(data_name)
        
        if test and kwargs['real']:
            self.box_creator = RealBoxCreator()
