...
class ExtlinkInterface(object):

    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), cdmesh_type='aabb', name='extlink'):
        self.name = name
        self.pos = pos
        self.rotmat = rotmat
        ...
        # extlink center
        self.extlink_center_pos = np.zeros(3)
        self.extlink_center_rotmat = np.eye(3)
        # collision detection
        self.cc = None
