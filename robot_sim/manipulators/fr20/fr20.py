...
class FR20(mi.ManipulatorInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(6),
        ...
        self.jlc.jnts[1]['loc_pos'] = np.array([0, 0, 0.215])
        self.jlc.jnts[1]['motion_rng'] = np.deg2rad([-175, 175])
        self.jlc.jnts[2]['loc_pos'] = np.array([0, 0.228, 0])
        ...
        self.jlc.jnts[3]['loc_pos'] = np.array([0, -0.200, 1.000])
        self.jlc.jnts[3]['loc_motionax'] = np.array([0, 1, 0])
        self.jlc.jnts[3]['motion_rng'] = np.deg2rad([-160, 160])
        self.jlc.jnts[4]['loc_pos'] = np.array([.0, .0, 0.716])
        ...
        self.jlc.lnks[0]['loc_rotmat'] = rm.rotmat_from_euler(0, 0, 0)
        ...
        self.jlc.lnks[2]['loc_rotmat'] = rm.rotmat_from_euler(0, 0, 0)
        ...
        self.jlc.lnks[3]['loc_rotmat'] = rm.rotmat_from_euler(0, 0, 0)
        ...
        self.jlc.lnks[4]['loc_rotmat'] = rm.rotmat_from_euler(0, 0, 0)
        ...
        self.jlc.lnks[5]['loc_rotmat'] = rm.rotmat_from_euler(0, 0, 0)
        ...
        self.jlc.lnks[6]['loc_rotmat'] = rm.rotmat_from_euler(0, 0, 0)
...
if __name__ == '__main__':
    ...
    manipulator_instance = FR20(enable_cc=True)
