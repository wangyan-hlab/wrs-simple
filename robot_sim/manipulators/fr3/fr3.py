...
class FR3(mi.ManipulatorInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(6),
        ...
        self.jlc.jnts[1]['loc_pos'] = np.array([0, 0, 0.140])
        self.jlc.jnts[1]['motion_rng'] = np.deg2rad([-175, 175])
        self.jlc.jnts[2]['loc_pos'] = np.array([0, 0.114, 0])
        ...
        self.jlc.jnts[3]['loc_pos'] = np.array([0, -0.114, 0.280])
        self.jlc.jnts[3]['loc_motionax'] = np.array([0, 1, 0])
        self.jlc.jnts[3]['motion_rng'] = np.deg2rad([-160, 160])
        self.jlc.jnts[4]['loc_pos'] = np.array([.0, .0, 0.240])
        ...
        self.jlc.jnts[5]['loc_pos'] = np.array([0, 0.102, 0])
        ...
        self.jlc.lnks[0]['loc_rotmat'] = rm.rotmat_from_euler(np.pi/2, .0, .0)
        ...
        self.jlc.lnks[1]['loc_pos'] = np.array([0, 0, -.0262])
        self.jlc.lnks[1]['loc_rotmat'] = rm.rotmat_from_euler(0, .0, np.pi)
        ...
        self.jlc.lnks[2]['loc_pos'] = np.array([.0, .0, .05])
        self.jlc.lnks[2]['loc_rotmat'] = rm.rotmat_from_euler(np.pi/2, -np.pi/2, 0)
        ...
        self.jlc.lnks[3]['loc_pos'] = np.array([.0, .05, .0])
        self.jlc.lnks[3]['loc_rotmat'] = rm.rotmat_from_euler(0, -np.pi/2, np.pi)
        ...
        self.jlc.lnks[4]['loc_pos'] = np.array([.0, .102, .0402])
        self.jlc.lnks[4]['loc_rotmat'] = rm.rotmat_from_euler(-np.pi/2, 0, -np.pi/2)
        ...
        self.jlc.lnks[5]['loc_pos'] = np.array([.0, .0402, .102])
        self.jlc.lnks[5]['loc_rotmat'] = rm.rotmat_from_euler(np.pi, np.pi/2, 0)
        ...
        self.jlc.lnks[6]['loc_pos'] = np.array([-.0003, .0542, .001])
        self.jlc.lnks[6]['loc_rotmat'] = rm.rotmat_from_euler(-np.pi/2, np.pi/2, np.pi)
...
if __name__ == '__main__':
    ...
    manipulator_instance = FR3(enable_cc=True)
