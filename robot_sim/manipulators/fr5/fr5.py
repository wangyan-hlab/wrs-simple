...
class FR5(mi.ManipulatorInterface):
    ...
    def __init__(self, pos=np.zeros(3), rotmat=np.eye(3), homeconf=np.zeros(6),
        ...
        self.jlc.jnts[1]['loc_pos'] = np.array([0, 0, 0.152])
        ...
        self.jlc.lnks[0]['loc_rotmat'] = rm.rotmat_from_euler(np.pi/2, .0, np.pi)
        ...
        self.jlc.lnks[1]['loc_pos'] = np.array([.0, .0, -.152])
        self.jlc.lnks[1]['loc_rotmat'] = rm.rotmat_from_euler(np.pi/2, .0, np.pi)
        ...
        self.jlc.lnks[4]['loc_pos'] = np.array([.0, .102, .0])
        ...
        self.jlc.lnks[5]['loc_pos'] = np.array([.0, .0, .102])
        ...
        self.jlc.lnks[6]['loc_pos'] = np.array([.0, .0542, .0])
